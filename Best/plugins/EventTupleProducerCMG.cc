#ifndef BESTAnalysis_TTbarLeptonJet_EventTupleProducerCMG_H
#define BESTAnalysis_TTbarLeptonJet_EventTupleProducerCMG_H
...
class EventTupleProducerCMG : public edm::EDAnalyzer
{
public:
  EventTupleProducerCMG(const edm::ParameterSet& pset);
  ~EventTupleProducerCMG();
...
template<typename Lepton>
EventTupleProducerCMG<Lepton>::EventTupleProducerCMG(const edm::ParameterSet& pset)
{
...
template<typename Lepton>
EventTupleProducerCMG<Lepton>::~EventTupleProducerCMG()
{
...
template<typename Lepton>
void EventTupleProducerCMG<Lepton>::analyze(const edm::Event& event, const edm::EventSetup& eventSetup)
{
  using namespace std;
  ...
  edm::Handle<edm::View<cmg::PFJet> > jetHandle;
  ...
  for ( int i=0, n=jetHandle->size(); i<n; ++i )
  {
    ...
    bTags_->push_back(jet.btag(bTagType_.c_str()));
...
template<typename Lepton>
bool EventTupleProducerCMG<Lepton>::hasMother(const reco::Candidate* p, const int pdgId)
{
...
typedef EventTupleProducerCMG<cmg::Electron> EventTupleProducerCMGElectron;
typedef EventTupleProducerCMG<cmg::Muon> EventTupleProducerCMGMuon;

DEFINE_FWK_MODULE(EventTupleProducerCMGElectron);
DEFINE_FWK_MODULE(EventTupleProducerCMGMuon);
